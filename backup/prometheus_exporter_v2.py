...
def format_metrics(sysbench_throughput, sysbench_latency, ab_metrics, cpu_usage,memory_usage):
    lines = []
...
def metrics():
    ...
    prometheus_metrics = format_metrics(sysbench_throughput, sysbench_latency, ab_metrics, cpu_usage, memory_usage)
