   ...
   # latency_metrics = {}
    ...
    for line in lines:
        if 'tps:' in line:
            ...
            sysbench_metrics['sysbench_throughput'] = tps

        if '99th percentile:' in line:
            latency_99th = float(re.search(r'99th percentile:\s+(\d+\.\d+)', line).group(1))
            sysbench_metrics['sysbench_latency_99th'] = latency_99th 


    return sysbench_metrics
...
def main():
    ...
    print("sysbench_metrics throughput:", sysbench_metrics)
